...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=50, init_weights=True, mode='train'):
...
# def VGG_MODEL(pretrained=True, progress=True, **kwargs):
#     model = _vgg('VGG_MODEL', vgg16, 'A', )
...
def model_vgg16(pretrained=True, **kwargs):
    vgg16_ = VGG(make_layers(cfgs['D'], batch_norm=True), **kwargs)
    if pretrained:
